;;; chiroptera-theme.el --- Theme using Template SCSS variables -*- lexical-binding: t -*-
...
(deftheme chiroptera "Theme using Template variables with quality of life improvements.")
...
(provide-theme 'chiroptera)
;;; chiroptera-theme.el ends here

---
title: Steam
description: Theming Steam client with Chiroptera
sidebar:
  order: 9
---

The official Steam client can be themed using the Chiroptera color scheme through the built-in theme system.\
...
1. **Enable Steam theming in Chiroptera:**
...
7. Regenerate a color scheme in Chiroptera (for example, toggling dark-light mode, or changing the wallpaper), and restart Steam.
...
The theme will automatically update when you change color schemes in Chiroptera.

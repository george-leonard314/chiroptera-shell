---
title: Discord
description: Theming Discord clients with Chiroptera
sidebar:
  order: 6
---

Chiroptera supports multiple Discord client alternatives that can be themed.
...
2. **Enable Discord theming in Chiroptera:**
...
3. **Enable theme in Discord:**
  ...
  - Toggle one of the two available Chiroptera themes

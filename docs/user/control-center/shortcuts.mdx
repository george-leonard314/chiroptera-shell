...
`screen_recorder` requires the official [`noctalia/screen_recorder` plugin](/chiroptera/plugins/official-plugins/#screen_recorder) to be enabled; without it the shortcut stays disabled.

## Related IPC

Many shortcut buttons trigger the same canonical IPC commands documented elsewhere:

- [System Controls](/chiroptera/ipc/system-controls/) for Wi-Fi, Bluetooth, night light, audio, caffeine, and power profile
- [Media & UI -> Notifications](/chiroptera/ipc/media-and-ui/#notifications) for DND
- [Media & UI -> Media](/chiroptera/ipc/media-and-ui/#media) for media controls
- [Media & UI -> Theme](/chiroptera/ipc/media-and-ui/#theme) for dark mode
- [Shell -> Session](/chiroptera/ipc/shell/#session) for session actions

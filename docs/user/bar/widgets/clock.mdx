...
| `tooltip_format` | string | `""` | Optional format shown when mouse is hovered over the clock widget. This utilizes the same [date format tokens](/chiroptera/configuration/date-format-tokens/) as format. |

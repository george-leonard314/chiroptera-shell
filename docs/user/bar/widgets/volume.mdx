...
```sh
# Output (speaker)
chiroptera msg volume-set 65
chiroptera msg volume-up
chiroptera msg volume-up 10
chiroptera msg volume-down
chiroptera msg volume-mute

# Input (microphone)
chiroptera msg mic-volume-set 0.5
chiroptera msg mic-volume-up
chiroptera msg mic-volume-up 5%
chiroptera msg mic-volume-down
chiroptera msg mic-mute
```

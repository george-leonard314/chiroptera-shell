...
Shows a custom glyph/image and an optional label. What it does on click and scroll is set with [widget actions](/chiroptera/bar/actions/).

| Setting | Type | Default | Description |
|---------|------|---------|-------------|
| `glyph` | string | `"heart"` | Bar glyph name: Chiroptera alias, Tabler icon name, or `U+` / `0x` codepoint |
...
left = "exec notify-send Chiroptera"

...
int main() {
  ...
  Config base;
  chiroptera::config::seedBuiltinWidgets(base);
  ...
  const WidgetConfig temp = chiroptera::config::readBarWidgetConfig("temp", *tempTable, base);
  ...
  const WidgetConfig custom = chiroptera::config::readBarWidgetConfig("my_clock", *customTable, base);
  ...
  const WidgetConfig layout = chiroptera::config::readBarWidgetConfig("keyboard_layout", *layoutTable, base);
  ...
  const auto mapValue = chiroptera::config::readWidgetSettingValue(*mapValueNode);
  ...
  ok = expect(
           !chiroptera::config::readWidgetSettingValue(*invalidMapValueNode).has_value(),

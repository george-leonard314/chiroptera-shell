...
void DesktopWidgetsController::registerIpc(IpcService& ipc) {
  ipc.registerHandler("desktop-widgets-edit", [this](const std::string&) -> std::string {
    enterEdit();
    return "ok\n";
  });

  ipc.registerHandler("desktop-widgets-exit", [this](const std::string&) -> std::string {
    exitEdit();
    return "ok\n";
  });

  ipc.registerHandler("desktop-widgets-toggle-edit", [this](const std::string&) -> std::string {
    toggleEdit();
    return "ok\n";
  });
  ...
  ipc.registerHandler("desktop-widgets-show", [this](const std::string&) -> std::string {
    setRuntimeVisibility(RuntimeVisibility::ForceShown);
    return "ok\n";
  });

  ipc.registerHandler("desktop-widgets-hide", [this](const std::string&) -> std::string {
    setRuntimeVisibility(RuntimeVisibility::ForceHidden);
    return "ok\n";
  });

  ipc.registerHandler("desktop-widgets-toggle", [this](const std::string&) -> std::string {

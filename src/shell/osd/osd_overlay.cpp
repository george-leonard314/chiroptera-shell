...
void OsdOverlay::registerIpc(IpcService& ipc) {
  ipc.bind(chiroptera::cli::msg::osdEnable, [this](const std::string& args) -> std::string {
  ...
  ipc.bind(chiroptera::cli::msg::osdDisable, [this](const std::string& args) -> std::string {
    if (!chiroptera::ipc::splitWords(args).empty()) {
  ...
  ipc.bind(chiroptera::cli::msg::osdToggle, [this](const std::string& args) -> std::string {
    if (!chiroptera::ipc::splitWords(args).empty()) {

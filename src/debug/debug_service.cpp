...
namespace {
  ...
  const sdbus::ServiceName kDebugBusName{"dev.chiroptera.Debug"};
  const sdbus::ObjectPath kDebugObjectPath{"/dev/chiroptera/Debug"};
  constexpr auto kDebugInterface = "dev.chiroptera.Debug";

...
void KeyboardBacklightService::registerIpc(IpcService& ipc) {
  ipc.bind(chiroptera::cli::msg::keyboardBacklightSet, [this](const std::string& args) -> std::string {
  ...
  ipc.bind(chiroptera::cli::msg::keyboardBacklightUp, [this](const std::string& args) -> std::string {
  ...
  ipc.bind(chiroptera::cli::msg::keyboardBacklightDown, [this](const std::string& args) -> std::string {
  ...
  ipc.bind(chiroptera::cli::msg::keyboardBacklightToggle, [this](const std::string& args) -> std::string {

...
void GammaService::registerIpc(IpcService& ipc) {
  ipc.registerHandler("nightlight-enable", [this](const std::string&) -> std::string {
    setEnabled(true);
    return "ok\n";
  });

  ipc.registerHandler("nightlight-disable", [this](const std::string&) -> std::string {
    setEnabled(false);
    return "ok\n";
  });

  ipc.registerHandler("nightlight-toggle", [this](const std::string&) -> std::string {
    toggleEnabled();
    return "ok\n";
  });

  ipc.registerHandler("nightlight-force-toggle", [this](const std::string&) -> std::string {
    toggleForceEnabled();
    return "ok\n";
  });
}

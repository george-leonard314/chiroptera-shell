...
void Application::initIpc() {
  ...
  m_ipcService.registerHandler(
      "notification-dnd-set", [this, applyNotificationDnd](const std::string& args) -> std::string {
        const auto parts = noctalia::ipc::splitWords(args);
        if (parts.size() != 1) {
  ...
  m_ipcService.registerHandler(
      "notification-dnd-toggle", [this, applyNotificationDnd](const std::string&) -> std::string {
  ...
  m_ipcService.registerHandler("notification-clear-active", [this](const std::string&) -> std::string {
  ...
  m_ipcService.registerHandler("notification-invoke-latest", [this](const std::string&) -> std::string {
  ...
  m_ipcService.registerHandler("notification-clear-history", [this](const std::string&) -> std::string {
  ...
  m_ipcService.registerHandler("notification-show", [this](const std::string& args) -> std::string {
  ...
  m_ipcService.registerHandler("clipboard-clear", [this](const std::string&) -> std::string {
    // Pinned entries survive; with nothing pinned this clears the whole history.
    m_clipboardService.clearUnpinnedHistory();
    return "ok\n";
  });

  m_ipcService.registerHandler("clipboard-copy", [this](const std::string& args) -> std::string {
    if (args.empty()) {
  ...
  m_ipcService.registerHandler("dpms-on", [this](const std::string&) -> std::string {
  ...
  m_ipcService.registerHandler("dpms-off", [this](const std::string&) -> std::string {
  ...
  m_ipcService.registerCycleHandler("workspace-switch", [this](const std::string& args) -> std::string {
    const auto parts = noctalia::ipc::splitWords(args);
  ...
  m_ipcService.registerCycleHandler("keyboard-layout-cycle", [this](const std::string& args) -> std::string {
  ...
  m_ipcService.registerHandler("workspace-alert-add", [this](const std::string& args) -> std::string {
  ...
  m_ipcService.registerHandler("workspace-alert-add-window", [this](const std::string& args) -> std::string {
    const auto parts = noctalia::ipc::splitWords(args);
    if (parts.size() != 1) {
  ...
  m_ipcService.registerHandler("workspace-alert-clear", [this](const std::string& args) -> std::string {
    const std::string workspace = StringUtils::trim(args);
    if (workspace.empty()) {
  ...
  m_ipcService.registerHandler("workspace-alert-clear-all", [this](const std::string& args) -> std::string {
    if (!noctalia::ipc::splitWords(args).empty()) {
  ...
  m_ipcService.registerHandler("keyboard-backlight-osd", [this](const std::string& args) -> std::string {
    const auto parts = noctalia::ipc::splitWords(args);
    if (parts.size() != 1) {
  ...
  m_ipcService.registerHandler("brightness-osd", [this](const std::string& args) -> std::string {
    const auto parts = noctalia::ipc::splitWords(args);
    if (parts.size() != 1) {
  ...
  m_ipcService.registerHandler("volume-osd", [this](const std::string& args) -> std::string {
    const auto parts = noctalia::ipc::splitWords(args);
    if (parts.size() > 1) {
  ...
  m_ipcService.registerHandler("mic-volume-osd", [this](const std::string& args) -> std::string {
    const auto parts = noctalia::ipc::splitWords(args);
    if (parts.size() > 1) {
  ...
  m_ipcService.registerHandler("plugin", [](const std::string& args) -> std::string {

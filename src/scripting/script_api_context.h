...
namespace scripting {
  ...
  // A connected output as exposed to plugin scripts via chiroptera.outputs().
  ...
  public:
    ...
    // Shell [shell].time_format / date_format — mirrored for chiroptera.timeFormat() / dateFormat().

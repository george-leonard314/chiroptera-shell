...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Richer GTK/AppIndicator tray compatibility harness for Chiroptera submenu testing."
    )
    parser.add_argument(
        "--force-appindicator",
        action="store_true",
...
class CompatTrayHarness:
    ...
    def setup(self) -> None:
        if self.backend_module is None:
            ...
            self.status_icon.set_name("chiroptera-tray-appindicator-compat-test")
        ...
        self.indicator = self.backend_module.Indicator.new(
            "chiroptera-tray-appindicator-compat-test",
            "applications-system",
